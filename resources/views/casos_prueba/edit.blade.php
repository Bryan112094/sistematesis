        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header"><div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="m-0">Editar Caso de prueba</h3>
                    </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('casos_prueba.update', [$project->id, $requirement->id, $caso_prueba->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <input type="hidden" name="creado_id" id="creado_id" value="{{ $caso_prueba->creado_id }}">
                        <input type="hidden" name="ejecutor_id" id="ejecutor_id" value="{{ Auth::user()->id }}">
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="creado" class="col-md-4 col-form-label text-md-end">Creado por</label>
                            <div class="col-md-6">
                                <input type="text" id="creado" name="creado" disabled class="form-control form-control-sm" value="{{ $caso_prueba->creador->name }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach($estados as &$estado)
                                    <option value="{{ $estado }}" @if($estado==$caso_prueba->estado) Selected @endif>{{ $estado }}</option>
                                @endforeach
                                </select>
                                @error('estado')
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <?php $caracs = explode(",", $caso_prueba->caracteristicas); ?>
                                ...
                                @foreach($caracteristicas as $caracteristica)
                                    <option value="{{ $caracteristica['id'] }}" @if(in_array($caracteristica['id'], $caracs)) Selected @endif>{{ $caracteristica['titulo'] }}</option>
                                @endforeach
                                </select>
