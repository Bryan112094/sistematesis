            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <p class="mb-1"><strong class="text-decoration-underline">Fecha tentativa:</strong> {{ date('d-m-Y', strtotime($requirement->fecha_tentativa)) }}</p>
                        <p><strong class="text-decoration-underline">Fecha real:</strong> {{ (!empty($requirement->fecha_real) ? date('Y-m-d', strtotime($requirement->fecha_real)) : '') }}</p>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample"><div class="accordion-body">
                                    <div class="table-responsive"><table class="table table-striped align-middle">
                                        ...
                                        <tbody>
                                            @foreach($requirement->historialanalistacalidad as $item)
                                            <tr>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample"><div class="accordion-body">
                                    <div class="table-responsive"><table class="table table-striped align-middle">
                                        ...
                                        <tbody>
                                            @foreach($requirement->historialfechatentativa as $item)
                                            <tr>
                                                <td>{{ date('d-m-Y', strtotime($item->created_at)) }}</td>
